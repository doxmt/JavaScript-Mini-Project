...
const alldrawButton = document.querySelector("#alldraw")
const onedrawButton = document.querySelector("#onedraw")
...
alldrawButton.addEventListener('click', function(){
...
onedrawButton.addEventListener('click', function(){
